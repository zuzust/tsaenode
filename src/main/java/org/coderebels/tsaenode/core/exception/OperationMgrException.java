 ...
 */
public class OperationMgrException extends AXCBaseException {
   ...
   */
  public OperationMgrException(String mesg, String triggerMethod) {
   ...
   */
  public OperationMgrException(String mesg, String triggerMethod, Throwable triggerException) {
