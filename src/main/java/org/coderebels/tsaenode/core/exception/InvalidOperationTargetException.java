 ...
 */
public class InvalidOperationTargetException extends AXCBaseException {
   ...
   */
  public InvalidOperationTargetException(String mesg, String triggerMethod) {
   ...
   */
  public InvalidOperationTargetException(String mesg, String triggerMethod, Throwable triggerException) {
