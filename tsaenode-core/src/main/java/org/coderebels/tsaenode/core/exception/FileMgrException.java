 ...
 */
public class FileMgrException extends AXCBaseException {
   ...
   */
  public FileMgrException(String mesg, String triggerMethod) {
   ...
   */
  public FileMgrException(String mesg, String triggerMethod, Throwable triggerException) {
